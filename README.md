...
**Colorized and formatted prompt for porfolio-site:**
```bash
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;38;5;1m\]\u\[\033[01;38;5;1m\]@\[\033[01;38;5;1m\]\h\[\033[00m\]   \[\033[01;38;5;27m\]\w\[\033[01;38;5;137m\]\n\[\033[01;38;5;15m\]> \[\033[00m\] '
else
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;38;5;1m\]\u\[\033[01;38;5;1m\]@\[\033[01;38;5;1m\]\h\[\033[00m\]   \[\033[01;38;5;27m\]\w\[\033[01;38;5;137m\]\n\[\033[01;38;5;15m\]> \[\033[00m\] '
fi
```

**Colorized and formatted prompt for aws ec2:**
```bash
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;38;5;208m\]\u\[\033[01;38;5;208m\]@\[\033[01;38;5;208m\]\h\[\033[00m\]   \[\033[01;38;5;27m\]\w\[\033[01;38;5;137m\]\n\[\033[01;38;5;15m\]> \[\033[00m\] '
else
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;38;5;208m\]\u\[\033[01;38;5;208m\]@\[\033[01;38;5;208m\]\h\[\033[00m\]   \[\033[01;38;5;27m\]\w\[\033[01;38;5;137m\]\n\[\033[01;38;5;15m\]> \[\033[00m\] '
fi
```
